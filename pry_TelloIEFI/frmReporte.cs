...
namespace pry_TelloIEFI
{
    public partial class frmReporte : Form
    {
        ...
        private void frmReporte_Load(object sender, EventArgs e)
        {
            ...
            if (dgvReporte.Columns.Contains("HoraIngreso"))
            {
                dgvReporte.Columns["HoraIngreso"].HeaderText = "Hora Ingreso";
                dgvReporte.Columns["HoraIngreso"].DefaultCellStyle.Format = @"hh\:mm";
            }

            if (dgvReporte.Columns.Contains("HoraSalida"))
            {
                dgvReporte.Columns["HoraSalida"].HeaderText = "Hora Salida";
